...
void ProfileImagePopup::onBtn1(CCObject*) {
    CCApplication::sharedApplication()->openURL(("https://gtps.undo.it/core-modules/ProfileImage/?accountID=" + to_string(GJAccountManager::sharedState()->m_nPlayerAccountID)).c_str());
    this->keyBackClicked();
}
